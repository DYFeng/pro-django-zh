...
- 注释(Comments) -- 有时候，一个函数实在太复杂了，在完整文档甚至docstring里找到的概述，都不能充分说明这一大段代码是用来干什么的。
...
对于Django的开发，还有Python的开发，你需要知道的第一件事就是：框架的代码是每个人都可以查看和修改(毕竟它是开源的)，但对核心的全权管理是由一小部分人监控的。
...
GitHub为此也提供了一个工具 *Gist* [#f14]_，可以跟IRC或者其他地方的用户分享代码。
